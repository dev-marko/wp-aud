...
public class DiscountRestController {
    ...
    // Moze da napravime da vrakja Page<> i bez .getContent() ke dobieme poveke
    // metapodatoci za Page objektot i drugi raboti
    ...
    // Koga kje wrap-nam objekt so ResponseEntity, mu ovozmozuvam da mi vrakja i
    // status kod, za da znam sto se slucilo ako ima nekoja greska
    @GetMapping("/{id}")
    ...
    public ResponseEntity deleteById(@PathVariable Long id) {
        ...
        if (this.discountService.findById(id).isPresent()) {
