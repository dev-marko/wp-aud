...
public class DiscountServiceImpl implements DiscountService {
    ...
    public Optional<Discount> save(DiscountDto discountDto) {
        Discount d = new Discount(discountDto.getValidUntil());
        return Optional.of(this.discountRepository.save(d));
    }

    @Override
    public Optional<Discount> edit(Long id, DiscountDto discountDto) {
        Discount d = this.discountRepository.findById(id).orElseThrow(() -> new DiscountNotFoundException(id));
        d.setValidUntil(discountDto.getValidUntil());
        return Optional.of(this.discountRepository.save(d));
    }
